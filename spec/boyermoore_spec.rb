...
describe "boyermoore" do
  ...
  #   pp BoyerMoore.compute_prefix(%w{A N P A N M A N})
  #   pp BoyerMoore.compute_prefix(%w{f o o b a r})
  # end

  # it "should compute badcharacter heuristics" do
  #   pp BoyerMoore.prepare_badcharacter_heuristic(%w{A N P A N M A N})
  #   # {"A"=>6, "M"=>5, "N"=>7, "P"=>2}
  #   pp BoyerMoore.prepare_badcharacter_heuristic(%w{f o o b a r})
  #   # {"a"=>4, "b"=>3, "o"=>2, "f"=>0, "r"=>5}
  # end

  # it "should prepare goodsuffix heuristics" do
  #   pp BoyerMoore.prepare_goodsuffix_heuristic(%w{A N P A N M A N})
  #   pp BoyerMoore.prepare_goodsuffix_heuristic(%w{f o o b a r})
  # end
